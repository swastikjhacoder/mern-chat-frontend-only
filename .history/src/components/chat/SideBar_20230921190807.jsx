      ...
      <div className="left-sidebar-container">
        ...
        <div className="sb-search">
          <div className="input-box">
            <input type="search" name="search" required="required" style={{border: `1px solid ${color}`, color: color}} />
            <span style={{color: color, border: `1px solid ${color}`, background: background}}>Search</span>
          </div>
        </div>
